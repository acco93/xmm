...
public class View extends JFrame implements ViewInterface {
    ...
    private UserInputPane bindToPane;
    ...
    @Override
    public BindingBundle showBindingInterface() {


        int result = JOptionPane.showConfirmDialog(null, bindToPane, "Bind to ...", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
        if (result == JOptionPane.OK_OPTION) {
            return bindToPane.get();
        }
        return null;
    ...
    @Override
    public void lockRunExternalProgram() {
        menu.lockRunExternalProgram();
    }

    @Override
    public void unlockRunExternalProgram() {
        menu.unlockRunExternalProgram();
    }
